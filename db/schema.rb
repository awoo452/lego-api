...
ActiveRecord::Schema[8.1].define(version: 2026_03_28_000002) do
  ...
  create_table "lego_sets", force: :cascade do |t|
    ...
    t.index ["external_id"], name: "index_lego_sets_on_external_id", unique: true
  end
  ...
  create_table "request_logs", force: :cascade do |t|
    ...
    t.index ["lego_set_id", "created_at"], name: "index_request_logs_on_lego_set_id_and_created_at"
    t.index ["lego_set_id"], name: "index_request_logs_on_lego_set_id"
    t.index ["path"], name: "index_request_logs_on_path"
    t.index ["request_id"], name: "index_request_logs_on_request_id"
  end

  add_foreign_key "request_logs", "lego_sets"
end
