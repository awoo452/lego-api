class ApplicationController < ActionController::API
  ...
  def create_request_log(duration_ms, error)
    RequestLog.create(
      ...
      lego_set_id: request_log_lego_set_id,
  ...
  def request_log_lego_set_id
    raw = request.env["request_log.lego_set_id"]
    return if raw.blank?
  ...
  def set_request_log_lego_set_id(lego_set_id)
    request.env["request_log.lego_set_id"] = lego_set_id
  end
end
